    ...
    <x-dialog-modal wire:model="abrirModalFestividades" maxWidth="3xl">
        ...
        <x-slot name="content">
            ...
            <article class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5 p-3">
                    ...
                    <button wire:click="cerrarFormulario" type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Ocultar</button>
