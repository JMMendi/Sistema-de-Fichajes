<x-plantilla.self>
    <div class="flex justify-center">
        <article class="w-1/2 flex flex-col shadow-xl border-2 border-black p-5 rounded-xl">
            ...
            <button type="submit" wire:click="store" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Registrar Usuario</button>
        </article>
    </div>
